...
For example:
```bash
uvx /path/to/your/whl/stata_mcp-1.7.3-py3-non-any.whl  # here is the wheel file name, you can change it to your version
```
...
### APA
```
Song Tan. (2025). Stata-MCP: Let LLM help you achieve your regression analysis with Stata (Version 1.7.3) [Computer software]. https://github.com/sepinetam/stata-mcp
```

### Chicago
```
Song Tan. 2025. "Stata-MCP: Let LLM help you achieve your regression analysis with Stata." Version 1.7.3. https://github.com/sepinetam/stata-mcp.
```
